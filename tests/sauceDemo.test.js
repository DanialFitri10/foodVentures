...
describe('Testing FoodVentures Web Page', () => {
    ...
    it('Should delete a resource when "Delete" button is clicked', async () => {
        try {
            // Store the initial count of resources before deletion (You may need to implement this logic based on your application).
            ...
            console.log('Clicked Delete button for the resource');
            ...
            try {
                ...
                if (successAlertText.includes('Resource added successfully')) {
                    console.log('Dismissed unexpected success alert after deletion');
                    await successAlert.dismiss();
                }
            } catch (alertError) {
                // No unexpected alert, continue with the test
            }

            // Optionally, you can verify that the resource is no longer present on the page.
    ...
    // it('Should add a resource with valid data set', async () => {
