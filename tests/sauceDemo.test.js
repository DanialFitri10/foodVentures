...
//         // Find an "Edit" button for a specific resource and wait for it to be clickable.
//         const editButton = await driver.findElement(By.xpath("//button[contains(text(),'Edit')]"));
//         await driver.wait(until.elementIsVisible(editButton), 5000);  // Adjust the timeout as needed
//         await editButton.click();
